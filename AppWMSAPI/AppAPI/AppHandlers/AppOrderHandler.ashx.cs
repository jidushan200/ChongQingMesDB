...
namespace AppAPI.AppHandlers
{
    ...
    /// 订单控制APP后台API
    /// </summary>
    public class AppOrderHandler : IHttpHandler
    {
        ...
        private void Query()
        {
            ...
            DataSet ds = SQLHelper.QueryDataSet(CommandType.StoredProcedure, "app_sch_order_sel", null);
            rModel.State = true;
        ...
        private void QueryInfo()
        {
            ...
            DataSet ds = SQLHelper.QueryDataSet(CommandType.StoredProcedure, "app_sch_order_info_sel", null);
            rModel.State = true;
        ...
        private void MoveUp()
        {
            ...
            try
            {
                ...
                SQLHelper.ExecuteNonQuery(CommandType.StoredProcedure, "app_sch_order_move_up", new SqlParameter("id", id));
                rModel.State = true;
                Response.Write(JSONHelper.ObjectToJSON(rModel));
            }
            catch (Exception ex)
        ...
        private void MoveDown()
        {
            ...
            try
            {
                ...
                SQLHelper.ExecuteNonQuery(CommandType.StoredProcedure, "app_sch_order_move_down", new SqlParameter("id", id));
                rModel.State = true;
                Response.Write(JSONHelper.ObjectToJSON(rModel));
            }
            catch (Exception ex)
